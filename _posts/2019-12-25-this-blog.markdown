...
excerpt: "jekyllで生成して無料サーバーXFREEで公開しているこのブログの成り立ちを簡単に"
categories: [General]
tag: [technical]
comments: true
---
このブログは[**jekyll**][jl]{:target="_blank"}を使って生成して，無料サーバー[**XFREE**][xf]{:target="_blank"}にアップして公開してる．  
...
[**jekyll**][jl]{:target="_blank"}はプログラマーが共同でプロジェクトを進めるためのサービスの[**GitHub**][gh]{:target="_blank"}というところで開発されてきたようで，  
サーバーを使わなくてもサイトを公開できる[**GitHub Pages**][gp]{:target="_blank"}というというものもあるらしい・・・  
